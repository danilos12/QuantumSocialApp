                    ...
                    <div class="card25 rounded-br w-full relative p-4">
                            ...
                            <div class=" " style="display:flex;flex-direction: column;justify-content:center;align-items:center; width: 100%">
                              ...
                              <!-- END .queued-single-end -->
                                ...
                                <?php if($plan->trial_counter !== -1): ?>
                                <div class="flex">
                                    <div class="a card-col-a">
                                        <span class="actual"><?php echo e($countTrial); ?></span>
                                    </div>
                                    <div class="b card-col-b">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/main/resources/views/dashboard.blade.php ENDPATH**/ ?>