...
<body class="<?php echo e(Route::has('login') ? 'darkmode' : ''); ?>">
  ...
  <div class="interface-outer">
    <div class="interface-inner">
        ...
        <div class="content-outer">
            <input id="getinput" type="text" placeholder="sampletext">
            <button class="hey">
                Button
            </button>
  ...
  <script>
    ...
    document.querySelector('.hey').addEventListener('click', function() {

        var input = document.getElementById('getinput').value;
        console.log(input);
        socket.emit('buttonClicked', input);
    });
...
<?php /**PATH D:\XAAMP\htdocs\Quantum\resources\views/layouts/app.blade.php ENDPATH**/ ?>