...
<div class="modal-large-outer posting-tool-outer">
                        <div class="modal-large-inner posting-tool-inner">
                         ...
                         <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close posting-tool-close" />
                                ...
                                <div class="new-post-wrap primary-post-wrap">
                                  ...
                                  <div class="post-area-left primary-post-left">
                                    <div class="post-area-wrap primary-post-area-wrap">
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-twitter.svg" class="ui-icon post-type-indicator indicator-active" />
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet.svg" class="ui-icon post-type-indicator" />
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-comments.svg" class="ui-icon post-type-indicator" />
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-evergreen.svg" class="ui-icon post-type-indicator" />
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/17-promos.svg" class="ui-icon post-type-indicator" />
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/08-tweet-storm.svg" class="ui-icon post-type-indicator" />
                                    ...
                                    <div class="post-bottom-buttons primary-post-bottom-buttons">
                                      <span class="post-type-buttons primary-post-type-buttons">
                                       ...
                                       <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet.svg" class="ui-icon post-tool-icon retweet-type-icon" />
                                       <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-comments.svg" class="ui-icon post-tool-icon comment-type-icon" />
                                      ...
                                      <span class="post-option-buttons primary-post-option-buttons">
                                       ...
                                       <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet-timer.svg" class="ui-icon post-tool-icon retweet-timer-icon" />
                                      ...
                                      <div class="post-tool-modal schedule-retweet-modal-outer frosted">
                                        <div class="schedule-retweet-modal-inner">
                                         <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon post-tool-modal-close retweet-modal-close" />
                                          Select A Post Time:
                                  ...
                                  <div class="post-area-right primary-post-right">
                                    <div class="post-right-buttons primary-post-right-buttons">
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-image.svg" class="ui-icon post-tool-icon add-image-icon" /><br />
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-gif.svg" class="ui-icon post-tool-icon add-gif-icon" /><br />
                                     <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-smile.svg" class="ui-icon post-tool-icon add-emoji-icon" /><br />
                                    </div>  <!-- END .primary-post-right-buttons -->
                                  </div>  <!-- END .primary-post-right -->

                                </div>  <!-- END .primary-post-wrap -->

                               <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/add-post.svg" class="ui-icon add-tweet-icon add-tweet-initial" />
                                ...
                                <div class="more-tweets-roster">
                                  ...
                                  <div class="add-tweet-outer">
                                      ...
                                      <div class="new-post-wrap add-tweet-col">
                                        <div class="post-area-left new-post-left">
                                          ...
                                          <div class="post-bottom-buttons new-post-bottom-buttons">
                                            <span class="post-type-buttons new-post-type-buttons">
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/16-evergreen.svg" class="ui-icon post-tool-icon evergreen-type-icon" />
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/17-promos.svg" class="ui-icon post-tool-icon promo-type-icon" />
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/08-tweet-storm.svg" class="ui-icon post-tool-icon tweet-storm-type-icon" />
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet.svg" class="ui-icon post-tool-icon retweet-type-icon" />
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-comments.svg" class="ui-icon post-tool-icon comment-type-icon" />
                                            ...
                                            <span class="post-option-buttons new-post-option-buttons">
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/14-hashtag-feeds.svg" class="ui-icon post-tool-icon hashtags-option-icon" />
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-envelope.svg" class="ui-icon post-tool-icon dm-option-icon" />
                                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-time.svg" class="ui-icon post-tool-icon send-timer-icon" />
                                        ...
                                        <div class="post-area-right new-post-right">
                                          <div class="post-right-buttons new-post-right-buttons">
                                           <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon post-tool-icon remove-new-tweet" /><br />
                                           <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-image.svg" class="ui-icon post-tool-icon add-image-icon" /><br />
                                           <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-gif.svg" class="ui-icon post-tool-icon add-gif-icon" /><br />
                                           <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-smile.svg" class="ui-icon post-tool-icon add-emoji-icon" /><br />
                                   ...
                                   <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/add-post.svg" class="ui-icon add-tweet-icon add-tweet-again-button" />
                              ...
                              <div class="posting-tool-col posting-tool-right-col">
                                ...
                                <div class="cross-tweet-profiles-outer">
                                  ...
                                  <div class="cross-tweet-profiles-inner">
                                   <img src="<?php echo e(asset('public/')); ?>/temp-images/william-wallace.jpg" class="cross-tweet-profile-image" status="active" />
                                   <img src="<?php echo e(asset('public/')); ?>/temp-images/william-wallace.jpg" class="cross-tweet-profile-image" status="active" />
                                   <img src="<?php echo e(asset('public/')); ?>/temp-images/william-wallace.jpg" class="cross-tweet-profile-image" />
                                   <img src="<?php echo e(asset('public/')); ?>/temp-images/william-wallace.jpg" class="cross-tweet-profile-image" status="active" />
                                   <img src="<?php echo e(asset('public/')); ?>/temp-images/william-wallace.jpg" class="cross-tweet-profile-image" />
                                   <img src="<?php echo e(asset('public/')); ?>/temp-images/william-wallace.jpg" class="cross-tweet-profile-image" status="active" />
                                   <img src="<?php echo e(asset('public/')); ?>/temp-images/william-wallace.jpg" class="cross-tweet-profile-image" />
    ...
    <!-- CARLO - These options only show up if certain options are selected in the scheduling method options -->
                      ...
                      </div>  <!-- END .posting-tool-outer --><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/commandmodule.blade.php ENDPATH**/ ?>