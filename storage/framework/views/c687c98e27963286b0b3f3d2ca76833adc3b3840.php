    ...
    <div class="filter-controls">
      <div class="drop-button-wrap filter-wrap queue-source-wrap">
        ...
        <ul class="page-filters-dropdown profile-filter-dropdown frosted">
          ...
          <li>
            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-evergreen.svg" class="ui-icon" />
            Evergreen
          </li>
          <li>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAAMP\htdocs\Quantum\resources\views/posted.blade.php ENDPATH**/ ?>