            ...
            <div class="menu-section-twirl-section-inner">
                ...
                <div class="menu-twirl-option-outer">
                    <div class="menu-twirl-option-inner">
                        ...
                        <div class="menu-twirl-right"><input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_10" <?php echo e(isset($twitterSettingsToggler) ? ($twitterSettingsToggler->toggle_10 === 1) ? 'checked' : '' : ''); ?>>
                        </div>  <!-- END .menu-twirl-right -->
                    </div>  <!-- END .menu-twirl-option-inner -->

                    <?php if(isset($twitterSettingsToggler)): ?>
                        <?php if($twitterSettingsToggler->toggle_10 === 1): ?> 
...
</div>  <!-- END .command-module-outer --><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/master-api-and-twapi.blade.php ENDPATH**/ ?>