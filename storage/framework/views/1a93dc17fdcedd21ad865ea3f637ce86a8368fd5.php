...
<div class="page-outer evergreen-outer">
                <div class="page-inner evergreen-inner">
                  ...
                  <div class="page-head-n-sort">
                    ...
                    <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/add-post.svg" class="ui-icon paste-evergreen-tweet" />
                    ...
                    <div class="profile-posts-inner">
                      ...
                      <div class="mosaic-posts-outer evergreen-mosaic" status="active">
                        <div class="mosaic-watermark-wrap frosted">
                          <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-evergreen.svg" class="mosaic-watermark evergreen-watermark" />
                          <div class="mosaic-posts-inner">

                            <div class="mosaic-post-controls">
                              <span class="mosaic-control-icon">
                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-add.svg"
                                class="ui-icon"/></span>

                                    <!-- This one gets deleted after JS toggle & status is working. -->
                                    <span class="mosaic-control-icon">
                                      <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-remove.svg" class="ui-icon"/></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/evergreentweets.blade.php ENDPATH**/ ?>