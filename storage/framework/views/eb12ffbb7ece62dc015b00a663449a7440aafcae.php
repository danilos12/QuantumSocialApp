...
<div class="modal-large-outer posting-tool-outer command-module-outer">
  <div class="modal-large-inner posting-tool-inner">
    ...
    <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close posting-tool-close" id="command-module"/>
          ...
          <div class="new-post-wrap primary-post-wrap">
            ...
            <div class="post-area-left primary-post-left">
              <div class="post-area-wrap primary-post-area-wrap">
                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-x.svg" class="ui-icon post-type-indicator indicator-active" data-src="twitter-tweets"/>
      ...
      <div class="posting-tool-submit-wrap">
        ...
        <div class="post-tool-submit-left">
          <select id="scheduling-options" name="scheduling-options" class="scheduling-options">
            ...
            <?php if($hasRegularTweetsInQueue): ?>
            <option value="add-queue">Add to Queue (default)</option>
            <?php endif; ?>
        ...
        <input type="submit" class="posting-tool-submit" value="Beam me up Scotty" id="beam-btn" <?php echo e($twitter_id === 0 ? 'disabled' : ""); ?> />
...
</style><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/main/resources/views/modals/commandmodule.blade.php ENDPATH**/ ?>