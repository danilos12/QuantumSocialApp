<div class="modal-large-outer main-settings-outer twitter-settings-outer frosted">
    <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close settings-close close-twitter-settings" id="twitter-settings"/>
    ...
    <div class="account-settings-header-wrap">
        ...
        <div class="global-twitter-profile-header profile-header-left">
            <a href="#">
                <img src="<?php echo e($selected_user ? $selected_user->twitter_photo : asset('public/temp-images/imgpsh_fullsize_anim (1).png')); ?>"
                class="global-profile-image" />
            </a>
            <div class="global-profile-details">
                <div class="global-profile-name text-right">
                    <?php echo e($selected_user ? $selected_user->twitter_name : 'No X account linked'); ?>

                </div>  <!-- END .global-author-name -->
                <div class="global-profile-subdata">
                    <span class="global-profile-handle">
                        <a href=""><?php echo e($selected_user ? "@" .$selected_user->twitter_username : ""); ?></a>
                    </span>
    ...
    <div class="modal-large-inner main-settings-inner twitter-settings-inner">
            ...
            <div class="menu-section-inner x-share-access-inner">
                ...
                <div class="menu-section-twirl-section-outer collapse" id="x-share-access-twirl">
                    <div class="menu-section-twirl-section-inner">
                        ...
                        <?php $__currentLoopData = $xmembersaccess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="menu-team-account-outer">
                          <div class="menu-team-account-inner">

                              <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/02-profile.svg" class="ui-icon watermark-rotate10" />
                              ...
                              <div class="global-profile-details">
                                  ...
                                  <?php if(Auth::guard('member')->user()->id == $member->id): ?>
                                   (You)
                                   <?php else: ?>
                                  ...
                                  <span class="global-profile-email">
                                      <a href=""><?php echo e($member->email); ?></a>
                                    </span>
                                  </div>  <!-- END .global-post-date-wrap -->
                              ...
                              <div class="menu-social-account-options">
                                ...
                                <div class="childs-cont-2">
                                  ...
                                  <div class="">
                                    ...
                                    <input type="checkbox" class="menu-twirl-toggle  twitteraccess" data-trid="<?php echo e($selected_user->id); ?>" datas-xant="<?php echo e($member->account_holder_id); ?>" name="grant-x-access" data-twitter-id="<?php echo e($selected_user->twitter_id); ?>" id="toggle_x-<?php echo e($member->id); ?>" <?php echo e($idscheck->contains('member_id',$member->id) && $idscheck->contains('mtwitter_id',$selected_user->twitter_id) ? 'checked' : ''); ?>>
                              ...
                              <div class="menu-social-account-options">
                                ...
                                <div class="childs-cont-2">
                                  ...
                                  <div class="">
                                    ...
                                    <input type="checkbox" class="menu-twirl-toggle twitteraccess" data-trid="<?php echo e($selected_user ? $selected_user->id : ''); ?>" datas-xant="<?php echo e($member->account_holder_id); ?>" name="grant-x-access" data-twitter-id="<?php echo e($selected_user ? $selected_user->twitter_id : ''); ?>" id="toggle_x-<?php echo e($member->id); ?>" <?php echo e($selected_user && $idscheck->contains('member_id', $member->id) && $idscheck->contains('mtwitter_id', $selected_user->twitter_id) ? 'checked' : ''); ?>>
        ...
        <?php if(isset($twitterSettings)): ?>
        <?php if($showTwitterSettings['auto_reply_text'] && $showTwitterSettings['text_draft_ender'] ): ?>
            ...
            <div class="menu-section-inner command-module-account-inner">
                <div class="menu-section-twirl-header-outer">
                    <div class="menu-section-twirl-header-inner">
                        ...
                        <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-arrow.svg" class="ui-icon menu-section-twirl-icon menu-section-command-twirl" data-toggle="collapse" data-target="#acct-menu-section-command-twirl" />
                ...
                <div class="menu-section-twirl-section-outer collapse" id="acct-menu-section-command-twirl">
                    <div class="menu-section-twirl-section-inner">
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                                ...
                                <div class="menu-twirl-right">
                                    <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_1" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_1 === 1) ? 'checked' : '' : ''); ?>>
                            ...
                            <div class="menu-subTwirl-outer">
                                ...
                                <div class="menu-subTwirl-inner">
                                    <textarea class="auto-reply-text" id="auto_reply_text"><?php echo e(isset($twitterSetting) ? $twitterSetting['auto_reply_text'] : ""); ?></textarea>
                        ...
                        <div class="menu-twirl-option-outer">
                            ...
                            <div class="menu-twirl-option-inner">
                                <div class="menu-twirl-left">
                                    <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-dots.svg" class="ui-icon menu-twirl-option-icon" />
                                    <span class="menu-twirl-option-text">
                                    Add a Thread Ender post to the end of threads asking them to follow and retweet the 1st post in your thread.</span>
                                </div>  <!-- END .menu-twirl-left -->
                                <div class="menu-twirl-right">
                                    <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_2" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_2 === 1) ? 'checked' : '' : ''); ?>>
                                </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                            ...
                            <div class="menu-subTwirl-outer">
                                ...
                                <div class="menu-subTwirl-inner">
                                    <textarea class="thread-ender-text" id="text_draft_ender"><?php echo e(isset($twitterSetting) ? $twitterSetting['text_draft_ender'] : ""); ?></textarea>
        ...
        <?php if($showTwitterSettings['set_default_acct'] ): ?>
                ...
                <div class="menu-section-twirl-section-outer collapse" id="automated-menu-section-preferences-twirl">
                    <div class="menu-section-twirl-section-inner">
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                            <div class="menu-twirl-left">
                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/16-evergreen.svg" class="ui-icon menu-twirl-option-icon" />
                                <span class="menu-twirl-option-text">
                                Clone high-engagement tweets into an Evergreen post.</span>
                            </div>  <!-- END .menu-twirl-left -->
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_3" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_3 === 1) ? 'checked' : '' : ''); ?>>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                            <!-- Start Evergreen -->
                            <div class="menu-subTwirl-outer">
                                ...
                                <div class="subTwirl-content">
                                    <div class="subTwirl-evergreen-retweets-wrap"> <!-- was "subTwirl-engagement-retweets-wrap" -->
                                        <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet.svg" class="ui-icon subTwirl-option-icon" />
                                        Retweet every
                                        <input type="text" class="subTwirl-micro-input" id="eg_rt_retweets" value="<?php echo e(isset($twitterSetting) ? $twitterSetting['eg_rt_retweets'] : ""); ?>"/>
                                    retweets.
                                    </div>  <!-- END .subTwirl-evergreen-retweets-wrap -->
                                    <div class="subTwirl-evergreen-likes-wrap">
                                        <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-heart.svg" class="ui-icon subTwirl-option-icon" />
                                        Retweet every
                                        <input type="text" class="subTwirl-micro-input" id="eg_rt_likes" value="<?php echo e(isset($twitterSetting) ? $twitterSetting['eg_rt_likes'] : ""); ?>"/>
                                    likes.
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                            <div class="menu-twirl-left">
                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/19-trending.svg" class="ui-icon menu-twirl-option-icon" />
                                <span class="menu-twirl-option-text">
                                Automatically retweet your own high-engagement tweets.</span>
                            </div>  <!-- END .menu-twirl-left -->
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_4" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_4 === 1) ? 'checked' : '' : ''); ?>>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                                        ...
                                        <div class="menu-subTwirl-outer">
                                            ...
                                            <div class="subTwirl-content">
                                                ...
                                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet.svg" class="ui-icon subTwirl-option-icon" />
                                                Retweet every
                                                <input type="text" class="subTwirl-micro-input" id="he_rt_retweets" value="<?php echo e(isset($twitterSetting) ? $twitterSetting['he_rt_retweets'] : ""); ?>"/>
                                                retweets.
                                                </div>  <!-- END .subTwirl-engagement-retweets-wrap -->
                                                <div class="subTwirl-engagement-likes-wrap">
                                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-heart.svg" class="ui-icon subTwirl-option-icon" />
                                                Retweet every
                                                <input type="text" class="subTwirl-micro-input" id="he_rt_likes" value="<?php echo e(isset($twitterSetting) ? $twitterSetting['he_rt_likes'] : ""); ?>"/>
                                                likes.
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                            <div class="menu-twirl-left">
                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/00h-followers.svg" class="ui-icon menu-twirl-option-icon" />
                                <span class="menu-twirl-option-text">
                                Set default accounts for automatic cross-retweeting via <?php echo e(!empty($selected_user->twitter_username) ? "@" . $selected_user->twitter_username : 'No username found'); ?>.</span>
                            </div>  <!-- END .menu-twirl-left -->
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_5" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_5 === 1) ? 'checked' : '' : ''); ?>>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                            <div class="menu-twirl-left">
                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet-timer.svg" class="ui-icon menu-twirl-option-icon" />
                                <span class="menu-twirl-option-text">
                                Automatically retweet your own tweets after some time has elapsed.</span>
                            </div>  <!-- END .menu-twirl-left -->
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_6" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_6 === 1) ? 'checked' : '' : ''); ?>>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        </div>  <!-- END .menu-twirl-option-outer -->
                                ...
                                <div class="subTwirl-content">
                                    <div class="subTwirl-auto-retweet-wrap">
                                        ...
                                        <select class="subTwirl-auto-retweet-time" id="rt_auto_time">
                                            <?php for($i=0; $i <= 90; $i++ ): ?>
                                            <option value="<?php echo e($i); ?>"  <?php echo e(isset($twitterSetting) ? ($twitterSetting['rt_auto_time'] === $i) ? "selected" : "" : ""); ?>><?php echo e($i); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        ...
                                        <?php $__currentLoopData = $timeframes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeframe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($timeframe); ?>" <?php echo e(isset($twitterSetting) ? ($twitterSetting['rt_auto_frame'] === $i) ? "selected" : "" : ""); ?> ><?php echo e($timeframe); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        for
                                        <select class="subTwirl-auto-retweet-iterations" id="rt_auto_ite" >
                                        <?php for($i=0; $i <= 12; $i++ ): ?>
                                            <option value="<?php echo e($i); ?>" <?php echo e(isset($twitterSetting) ? ($twitterSetting['rt_auto_ite'] === $i) ? "selected" : "" : ""); ?>><?php echo e($i); ?></option>
                                        <?php endfor; ?>
                                        </select>
                                        iterations.
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                                ...
                                <div class="menu-twirl-right">
                                    <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_7" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_7 === 1) ? 'checked' : '' : ''); ?>>
                                </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        </div>  <!-- END .menu-twirl-option-outer -->
                                ...
                                <div class="subTwirl-content">
                                    <div class="subTwirl-remove-retweet-wrap">
                                        ...
                                        <select class="subTwirl-remove-retweet-time" id="rt_auto_rm_time">
                                            <?php for($i=0; $i<=90; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php echo e(isset($twitterSetting) ? ($twitterSetting['rt_auto_rm_time'] === $i) ? "selected" : "" : ""); ?> ><?php echo e($i); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        <select class="subTwirl-remove-retweet-frame" id="rt_auto_rm_frame">
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $timeframes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeframe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($timeframe); ?>" <?php echo e(isset($twitterSetting) ? ($twitterSetting['rt_auto_rm_frame'] === $i) ? "selected" : "" : ""); ?>  ><?php echo e($timeframe); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>  <!-- END .subTwirl-auto-retweet-wrap -->
                                </div>  <!-- END .subTwirl-content -->
        ...
        <?php if($showTwitterSettings['text_comment_offer'] && $showTwitterSettings['text_ender_dm'] ): ?>
        <div class="menu-section-outer automated-booster-outer">
            <div class="menu-section-inner automated-booster-inner">
                    ...
                    <div class="menu-section-twirl-section-inner">
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                                ...
                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-clone.svg" class="ui-icon menu-twirl-option-icon" />
                                <span class="menu-twirl-option-text">
                                    Automatically comment your offer, if any post goes viral.</span>
                                </div>  <!-- END .menu-twirl-left -->
                                <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_8" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_8 === 1) ? 'checked' : '' : ''); ?>>
                                </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                            ...
                            <div class="menu-subTwirl-outer">
                                ...
                                <div class="menu-subTwirl-inner">
                                    <textarea class="thread-ender-text" id="text_comment_offer"><?php echo e(isset($twitterSetting) ? $twitterSetting['text_comment_offer'] : ""); ?></textarea>
                                    <div class="thread-ender-counter">
                                    <span class="thread-ender-count">154</span>/280 remaining
                                    </div>  <!-- END .thread-ender-count -->
                        ...
                        <div class="menu-twirl-option-inner">
                            <div class="menu-twirl-left">
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-dm.svg" class="ui-icon menu-twirl-option-icon" />
                            <span class="menu-twirl-option-text">
                                Auto-send welcome Direct Message to new followers</span>
                            </div>  <!-- END .menu-twirl-left -->
                            <div class="menu-twirl-right">
                            <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_9" <?php echo e(isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_9 === 1) ? 'checked' : '' : ''); ?>>
                            </div>  <!-- END .menu-twirl-right -->
                        </div>  <!-- END .menu-twirl-option-inner -->
                                        ...
                                        <div class="menu-subTwirl-inner">
                                            <textarea class="thread-ender-text" id="text_ender_dm" ><?php echo e(isset($twitterSetting) ? $twitterSetting['text_ender_dm'] : ""); ?></textarea>
                                            <div class="thread-ender-counter">
                                            <span class="thread-ender-count">154</span>/280 remaining
                                            </div>  <!-- END .thread-ender-count -->
            ...
            </div>  <!-- END .automated-booster-inner -->
        </div>  <!-- END .automated-booster-outer -->
        <?php endif; ?>
        <?php endif; ?>
...
<script type='text/javascript' src="<?php echo e(asset('public/js/twitterSettings.js')); ?>"></script>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/main/resources/views/twittersettings.blade.php ENDPATH**/ ?>