                    ...
                    <div class="profile-posts-inner">
                      ...
                      <div class="mosaic-posts-outer promo-mosaic" status="active">
                        <div class="mosaic-watermark-wrap frosted">
                          <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/17-promos.svg" class="mosaic-watermark promo-watermark" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/promo-tweets.blade.php ENDPATH**/ ?>