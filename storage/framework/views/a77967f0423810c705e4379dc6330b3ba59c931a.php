    ...
    <div class="modal-large-backdrop-inactive">
        ...
        <div id="showinactive" class=" modal-large-outer-upgrade">
                ...
                <div class="w-full flex justify-end">
                    ...
                    <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="m-8 ui-icon  modal-large-close " id="close-inactive"/>
                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/main/resources/views/modals/inactive-box.blade.php ENDPATH**/ ?>