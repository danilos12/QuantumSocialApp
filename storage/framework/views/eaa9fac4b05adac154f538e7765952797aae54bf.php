  <!-- BEGIN MAIN MENU -->
                  ...
                  <div class="modal-large-anchor main-settings-anchor">
                    <div class="modal-large-backdrop main-settings-background">
                      ...
                      <div class="modal-large-outer main-settings-outer accounts-menu-outer frosted">
                       ...
                       <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close settings-close" />
                        ...
                        <div class="modal-large-inner main-settings-inner accounts-menu-inner">
              ...
              <!-- INGRID - We need a retweet icon like the retweet one above, except instead of a timer, we need a minus sign -->
                  ...
                  <!-- END POSTING TOOL --><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/slot.blade.php ENDPATH**/ ?>