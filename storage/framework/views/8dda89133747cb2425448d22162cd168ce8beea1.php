    ...
    <div class="modal-large-backdrop">
      ...
      <div class="add-team-member-modal">
        <div class="add-team-member-inner montserrat " style="color: white">
          <img src="<?php echo e(asset('public/')); ?>/ui-images/icon2/Edit.svg" class="editiconadd" id=""/>
      ...
      <div class="change-pass-modal" style="display: none">
        <div class="change-pass-inner frosted">
            ...
            <img src="<?php echo e(asset('public/')); ?>/ui-images/icon2/Edit.svg" class="editiconadd" id=""/>
            <div class="exit-button" >
              <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon settings-close close-change-pass" id="close-change-pass"/>
            </div>
      ...
      <div class="modal-large-outer main-settings-outer general-settings-outer frosted">
        <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close settings-close close-general-settings" id="general-settings"/>
        ...
        <div class="modal-large-inner main-settings-inner general-settings-inner">
              ...
              <span class="menu-section-header">
                  ...
                  <div class="settings-item-data-wrap">
                    <span class="settings-item-data account-email">
                      <?php if(Auth::guard('member')->check()): ?>
                          <?php echo e(Auth::guard('member')->user()->email); ?>
                ...
                <div class="settings-item-wrap plan-data-wrap">
                  ...
                  <div class="settings-item-data-wrap">
                    ...
                    ?> 
                    <span class="settings-item-data subscription-text"><?php echo e($tier); ?> Plan</span>
                ...
                <div class="settings-item-wrap timezone-data-wrap">
                  ...
                  <div class="settings-item-data-wrap">
                    ...
                    <select name="timezone_offset" id="timezone-offset" class="time-zone-data">
                      ...
                      <option value='<?php echo e(isset($timezone) ? $timezone->value : ""); ?>' <?php echo e(isset($timezone) ? ($mainUser->timezone ?? "") === $timezone->value ? "selected" : "" : ""); ?>><?php echo e(isset($timezone) ? $timezone->label : ""); ?></option>
          ...
          <?php if(Auth::guard('web')->check() || Auth::guard('member')->check()): ?>
              ...
              <span class="menu-section-header">Team Members </span>
                      ...
                      <div class="menu-team-account-inner">
                          ...
                          <div class="menu-social-account-options">
                            ...
                            <div class="childs-cont-2">
                              ...
                              <div class="">
                                  ...
                                  <input type="checkbox" class="menu-twirl-toggle adminaccess" name="grant-admin-access" id="toggle_admin-<?php echo e($member->id); ?>" <?php echo $member->admin_access == 1 ? 'checked' : ''; ?>>
                            ...
                            <div class="childs-cont">
                              ...
                              <input  type="checkbox" class="menu-twirl-toggle forchecked apiaccess" name="grant-api-access" id="toggle_api-<?php echo e($member->id); ?>" <?php echo $member->api_access == 1 ? 'checked' :'';?>>
                            </div>
                            </div>


                            <span class="menu-account-icons">
                             <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/05-drafts.svg" class="ui-icon menu-account-icons-img editing" title="Edit" data-toggle="tooltip" id="_edit-<?php echo e($member->id); ?>"/>
                                <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-trash.svg" class="ui-icon menu-account-icons-img deleting" title="Delete" data-toggle="tooltip" id="_delete-<?php echo e($member->id); ?>" />
                            </span>
                          </div>
                          ...
                          <div class="menu-social-account-options">
                            ...
                            <div class="childs-cont">
                              ...
                              <input  type="checkbox" class="menu-twirl-toggle  apiaccess" name="grant-api-access" id="toggle_api-<?php echo e($member->id); ?>" <?php echo $member->api_access == 1 ? 'checked' :'';?>>
                            </div>
                            </div>
                ...
                <div class="menu-team-members-add-accounts-section">
                  <div class="add-account add-team">
                      <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/02-profile.svg" class="ui-icon" />
                      + Add New Member
          ...
          <?php if($membership->trial_credits > 0): ?>
              ...
              <div class="menu-twirl-option-outer">
                <div class="menu-twirl-option-inner">
                  ...
                  <div class="menu-twirl-right">
                    ...
                    <input type="checkbox" class="menu-twirl-toggle" name="general-settings[]" id="toggle_1" <?php echo e(isset($generalSetting) ? ($generalSetting->toggle_1 === 1) ? 'checked' : '' : ''); ?>>
                ...
                <div class="menu-subTwirl-outer">
                  <form id="master_api_form">
                    ...
                    <div class="menu-subTwirl-inner">
                      <input type="text" class="input-field" id="api_key" name="api_key" value="<?php echo e(isset($twitterApiMaster) ? $twitterApiMaster->api_key  : ''); ?>"/>
                    </div>
                    <div class="subTwirl-header-wrap">
                        <span class="subTwirl-header">API Secret:</span>
                    </div>
                    <div class="menu-subTwirl-inner input-group">
                      <input type="password" class="input-field" id="api_secret" name="api_secret" value="<?php echo e(isset($twitterApiMaster) ? $twitterApiMaster->api_secret  : ''); ?>"/>
                      <div class="input-group-append">
                        <span class="input-group-text"><img src="<?php echo e(asset('public')); ?>/ui-images/icons/eye-open.svg" alt="password" class="secrets" id="api_secret"></span>
                      </div>
                    </div>
                    <div class="subTwirl-header-wrap">
                    ...
                    <div class="menu-subTwirl-inner">
                      <input type="text" class="input-field" id="bearer_token" name="bearer_token" value="<?php echo e(isset($twitterApiMaster) ? $twitterApiMaster->bearer_token : ''); ?>"/>
                    </div>
                    <div class="subTwirl-header-wrap">
                      <span class="subTwirl-header">OAuth 2.0 ID:</span>
                    </div>
                    <div class="menu-subTwirl-inner">
                      <input type="text" class="input-field" id="oauth_id" name="oauth_id" value="<?php echo e(isset($twitterApiMaster) ? $twitterApiMaster->oauth_id : ''); ?>"/>
                    </div>
                    <div class="subTwirl-header-wrap">
                      <span class="subTwirl-header">OAuth 2.0 Secret:</span>
                    </div>
                    <div class="menu-subTwirl-inner input-group">
                      <input type="password" class="input-field" id="oauth_secret" name="oauth_secret" value="<?php echo e(isset($twitterApiMaster) ? $twitterApiMaster->oauth_secret : ''); ?>"/>
                      <div class="input-group-append">
                        <span class="input-group-text"><img src="<?php echo e(asset('public')); ?>/ui-images/icons/eye-open.svg" alt="password" class="secrets" id="oauth_secret"></span>
                      </div>
                    </div>
                    <div class="subTwirl-header-wrap">
                    ...
                    <div class="menu-subTwirl-inner">
                      <input type="text" class="input-field" id="callback_url" name="callback_url" value="<?php echo e(isset($twitterApiMaster) ? $twitterApiMaster->callback_url : 'https://app.quantumsocial.io/twitter/oauth'); ?>" readonly/>
                    </div>
                ...
                <div class="menu-twirl-option-inner">
                  ...
                  <div class="menu-twirl-right"><input type="checkbox" class="menu-twirl-toggle" name="general-settings[]" id="toggle_7" <?php echo e(isset($generalSetting) ? ($generalSetting->toggle_7 === 1) ? 'checked' : '' : ''); ?>>
                  </div>  <!-- END .menu-twirl-right -->
                </div>  <!-- END .menu-twirl-option-inner -->
          ...
          <?php elseif(Auth::guard('member')->user()->api_access == 1): ?>
          <?php if(auth()->guard('member')->check()): ?>
            ...
            <div class="menu-section-inner social-accounts-inner">
              <span class="menu-section-header">Social Accounts</span>
                <?php if($acct_twitter_count > 0): ?>
                      <?php $__currentLoopData = $twitter_accts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <!-- BEGIN .menu-social-account Instance -->
                      <div class="menu-social-account-outer">
                        <div class="menu-social-account-inner">

                        <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-x.svg" class="ui-icon menu-account-type-icon" />

                          <div class="global-twitter-profile-header">
                            <a href="#">
                            <img src="<?php echo e($acct->twitter_photo); ?>"
                                class="global-profile-image" /></a>
                            <div class="global-profile-details">
                              <div class="global-profile-name">
                                <a href="#">
                                  <?php echo e($acct->twitter_name); ?></a>
                              </div>  <!-- END .global-author-name -->
                              <div class="global-profile-subdata">
                                <span class="global-profile-handle">
                                  @<a href=""><?php echo e($acct->twitter_username); ?></a>
                                </span>
                              </div>  <!-- END .global-post-date-wrap -->
                          ...
                          <span class="menu-account-icons">
                            <span class="menu-account-default" data-twitter_id="<?php echo e($acct->twitter_id); ?>" data-toggle="tooltip" title="Set default account. Page will reload after select" default="<?php echo e(isset($selected_user) ? ($selected_user->twitter_id === $acct->twitter_id ? 'active' : '') : ''); ?>"></span>
                            <?php if($selected_user->twitter_id === $acct->twitter_id): ?>
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/00j-x-settings.svg" class="ui-icon ui-icon-width" title="Twitter Settings" id="x-twitter-settings" data-icon="twitter-settings" data-toggle="tooltip" />
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-trash.svg" data-twitterid="<?php echo e($acct->twitter_id); ?>" id="<?php echo e($acct->twitter_id); ?>"  class="ui-icon delete-account" title="Delete" data-toggle="tooltip" />
                            <?php else: ?>
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-trash.svg" data-twitterid="<?php echo e($acct->twitter_id); ?>" id="<?php echo e($acct->twitter_id); ?>"  class="ui-icon delete-account" title="Delete" data-toggle="tooltip" />
                            <?php endif; ?>
                          </span>
                ...
                <div class="menu-social-add-accounts-section">
                  <div class="add-account add-twitter-account" id="link-twitter" style="width: 15%">
                    <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-x.svg" class="ui-icon vertical-middle" />
                  ...
                  <div class="menu-section-twirl-section-inner">
                    ...
                    <div class="menu-twirl-option-outer">
                      <div class="menu-twirl-option-inner">
                        ...
                        <div class="menu-twirl-right">
                          <input type="checkbox" class="menu-twirl-toggle" name="general-settings[]" id="toggle_2"  <?php echo e(isset($generalSetting) ? ($generalSetting->toggle_2 === 1) ? 'checked' : '' : ''); ?>>
                        </div>  <!-- END .menu-twirl-right -->
                      </div>  <!-- END .menu-twirl-option-inner -->
                    </div>  <!-- END .menu-twirl-option-outer -->
                    ...
                    <div class="menu-twirl-option-outer">
                      <div class="menu-twirl-option-inner">
                        ...
                        <div class="menu-twirl-right">
                          <input type="checkbox" class="menu-twirl-toggle" name="general-settings[]" id="toggle_3"  <?php echo e(isset($generalSetting) ? ($generalSetting->toggle_3 === 1) ? 'checked' : '' : ''); ?>>
                        </div>  <!-- END .menu-twirl-right -->
                      </div>  <!-- END .menu-twirl-option-inner -->
                    </div>  <!-- END .menu-twirl-option-outer -->
                  ...
                  <div class="menu-section-twirl-section-inner">
                    ...
                    <div class="menu-twirl-option-outer">
                      <div class="menu-twirl-option-inner">
                        ...
                        <div class="menu-twirl-right">
                          <input type="checkbox" class="menu-twirl-toggle" name="general-settings[]" id="toggle_4"  <?php echo e(isset($generalSetting) ? ($generalSetting->toggle_4 === 1) ? 'checked' : '' : ''); ?>>
                        </div>  <!-- END .menu-twirl-right -->
                    ...
                    <div class="menu-twirl-option-outer">
                      <div class="menu-twirl-option-inner">
                        ...
                        <div class="menu-twirl-right">
                          <input type="checkbox" class="menu-twirl-toggle" name="general-settings[]" id="toggle_5"  <?php echo e(isset($generalSetting) ? ($generalSetting->toggle_5 === 1) ? 'checked' : '' : ''); ?>>
                        </div>  <!-- END .menu-twirl-right -->
                    ...
                    <div class="menu-twirl-option-outer">
                      <div class="menu-twirl-option-inner">
                        ...
                        <div class="menu-twirl-right">
                          <input type="checkbox" class="menu-twirl-toggle" name="general-settings[]" id="toggle_6"  <?php echo e(isset($generalSetting) ? ($generalSetting->toggle_6 === 1) ? 'checked' : '' : ''); ?>>
                        </div>  <!-- END .menu-twirl-right -->
      ...
      <?php echo $__env->make('twittersettings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


      <?php echo $__env->make('modals.commandmodule', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/main/resources/views/account-menu.blade.php ENDPATH**/ ?>