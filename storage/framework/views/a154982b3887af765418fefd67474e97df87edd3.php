    ...
    <div class="add-api-modal" style="display:none;">
        <div class="add-api-inner frosted">
            ...
            <div class="exit-button" >
              <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon settings-close close-add-api" id="close-add-api"/>
            </div>
        ...
        <div class="modal-large-outer-onboard  onboard-page-outer frosted">
            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close settings-close close-onboard-page"/>
...
</script><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/modals/onboard.blade.php ENDPATH**/ ?>