...
<script>
    $(document).ready(function() {
        ...
        $('form').submit(function(event) {
            ...
            $.ajax({
                url: '<?php echo e(route("tocontroller")); ?>',
                type: 'POST',
                data: formData,
                success: function(response) {
                        ...
                        if(response.stat=='success'){
                            ...
                            setTimeout(function() {
                                ...
                                window.location.href = "<?php echo e(route('forauth')); ?>";
                            }, 3000);
                ...
                error: function(xhr, status, error) {
                    ...
                    if (response && response.errors) {
                        ...
                        setTimeout(function() {
                            $('.error-message').fadeOut('slow');
                            window.location.href = "<?php echo e(route('session-login')); ?>";
                        }, 3000);
                    }
                }
            });
...
<?php echo $__env->make('layouts.check', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/emails/team_members_registration.blade.php ENDPATH**/ ?>