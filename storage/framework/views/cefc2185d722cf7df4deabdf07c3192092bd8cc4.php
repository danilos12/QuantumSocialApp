 <div class="modal-large-anchor">
                    <div class="modal-large-backdrop">
                      ...
                      <div class="modal-large-outer main-settings-outer general-settings-outer frosted">
                       ...
                       <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close settings-close close-general-settings" />
                      ...
                      <div class="modal-large-outer main-settings-outer twitter-settings-outer frosted">
                       ...
                       <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-close.svg" class="ui-icon modal-large-close settings-close close-twitter-settings" />
                                          ...
                                          <input type="checkbox" class="menu-twirl-toggle">
                                                    ...
                                                    <div class="menu-subTwirl-outer">
                                                      ...
                                                      <div class="menu-subTwirl-inner">
                                                        <textarea class="thread-ender-text">If you liked this thread then please follow me (@accountHandle) and share this thread by retweeting the first tweet: <br /><br /><?php echo e(01); ?></textarea>
              ...
              <!-- INGRID - We need a retweet icon like the retweet one above, except instead of a timer, we need a minus sign -->
                  ...
                  <!-- INGRID - We need a retweet icon like the retweet one above, except instead of a timer, we need a comment icon -->
                    ...
                    <?php echo $__env->make('commandmodule', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</style><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/account-menu.blade.php ENDPATH**/ ?>