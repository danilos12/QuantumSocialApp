                            ...
                            <div class="tag-group-controller">
                              <div class"tag-group-option">
                                <span class="tag-option-title-wrap">
                                  <img src="<?php echo e(asset('public/')); ?>/" class="ui-icon tag-option-icon" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/tags-groups.blade.php ENDPATH**/ ?>