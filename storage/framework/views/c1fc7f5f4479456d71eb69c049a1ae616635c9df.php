                  ...
                  <div class="filter-controls">
                    <div class="drop-button-wrap filter-wrap queue-source-wrap">
                      ...
                      <ul class="page-filters-dropdown profile-filter-dropdown frosted">
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/04-queue.svg" class="ui-icon" />
                          All (0)</li>
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-twitter.svg" class="ui-icon" />
                          Non-Campaign (0)</li>
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-evergreen.svg" class="ui-icon" />
                          Evergreen</li>
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet.svg" class="ui-icon" />
                          Retweets</li>
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/17-promos.svg" class="ui-icon" />
                    ...
                    <div class="drop-button-wrap sort-wrap">
                      ...
                      <ul class="page-filters-dropdown profile-sort-dropdown queue-months-dropdown frosted">
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/07-schedule.svg" class="ui-icon" />
                          December 2022</li>
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/07-schedule.svg" class="ui-icon" />
                          January 2023</li>
                        <li><img src="<?php echo e(asset('public/')); ?>/ui-images/icons/07-schedule.svg" class="ui-icon" />
                      ...
                      <div class="queue-day-wrapper">
                        ...
                        <div class="queued-single-post-wrapper queue-type-custom" status="active" queue-type="custom">
                          <div class="queued-single-post">
                            ...
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-twitter.svg" class="queued-watermark" />
                        ...
                        <!-- BEGIN Custom Queued Post Instance  (CUSTOM INACTIVE) -->
                        <div class="queued-single-post-wrapper queue-type-custom" status="inactive" queue-type="custom">
                          <div class="queued-single-post">
                        ...
                        <!-- BEGIN Empty Queued Post Instance -->
                        <div class="queued-single-post-wrapper queue-type-empty" status="active" queue-type="empty">
                          <div class="queued-single-post">
                        ...
                        <!-- END Empty Queued Post Instance -->
                        ...
                        <div class="queued-single-post-wrapper queue-type-comment" status="active" queue-type="comment">
                          <div class="queued-single-post">
                            ...
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/12-mentions.svg" class="queued-watermark" />
                            ...
                            <div class="queued-single-end">
                              ...
                              <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/05-drafts.svg"
                                class="ui-icon queued-icon queued-edit-icon" />
                              <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-twitter.svg"
                        ...
                        <div class="queued-single-post-wrapper queue-type-retweet" status="active" queue-type="retweet">
                          <div class="queued-single-post">
                            ...
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-retweet.svg" class="queued-watermark" />
                        ...
                        <div class="queued-single-post-wrapper queue-type-evergreen" status="active" queue-type="evergreen">
                          <div class="queued-single-post">
                            ...
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/pg-evergreen.svg" class="queued-watermark" />
                        ...
                        <div class="queued-single-post-wrapper queue-type-promo" status="active" queue-type="promo">
                          <div class="queued-single-post">
                            ...
                            <img src="<?php echo e(asset('public/')); ?>/ui-images/icons/17-promos.svg" class="queued-watermark" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quantum_social/app.quantumsocial.io/resources/views/queue.blade.php ENDPATH**/ ?>