...
class CommandmoduleController extends Controller
{
    ...
    public function create(Request $request) {
        ...
        // is postCredit a number and monthly post credit <= total post in current month
        // run if total post in current month exceed monthly post credit
