<div class="modal-large-outer main-settings-outer twitter-settings-outer frosted">
    ...
    <div class="modal-large-inner main-settings-inner twitter-settings-inner">
        ...
        @if($showTwitterSettings['auto_reply_text'] && $showTwitterSettings['text_draft_ender'] )
                    ...
                    <div class="menu-section-twirl-section-inner">
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                                ...
                                <div class="menu-twirl-right">
                                    <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_1" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_1 === 1) ? 'checked' : '' : ''}}>
                        ...
                        <div class="menu-twirl-option-outer">
                            ...
                            <div class="menu-twirl-option-inner">
                                ...
                                <div class="menu-twirl-right">
                                    <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_2" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_2 === 1) ? 'checked' : '' : ''}}>
                                </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
        ...
        @if($showTwitterSettings['set_default_acct'] )
                ...
                <div class="menu-section-twirl-section-outer collapse" id="automated-menu-section-preferences-twirl">
                    <div class="menu-section-twirl-section-inner">
                        ...
                        <div class="menu-twirl-option-outer">
                            ...
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_3" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_3 === 1) ? 'checked' : '' : ''}}>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                            <!-- Start Evergreen -->
                            <div class="menu-subTwirl-outer">
                        ...
                        <div class="menu-twirl-option-outer">
                            ...
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_4" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_4 === 1) ? 'checked' : '' : ''}}>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        ...
                        <div class="menu-twirl-option-outer">
                            ...
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_5" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_5 === 1) ? 'checked' : '' : ''}}>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        ...
                        <div class="menu-twirl-option-outer">
                            ...
                            <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_6" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_6 === 1) ? 'checked' : '' : ''}}>
                            </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        </div>  <!-- END .menu-twirl-option-outer -->
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                                ...
                                <div class="menu-twirl-right">
                                    <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_7" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_7 === 1) ? 'checked' : '' : ''}}>
                                </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        </div>  <!-- END .menu-twirl-option-outer -->
        ...
        @if($showTwitterSettings['text_comment_offer'] && $showTwitterSettings['text_ender_dm'] )
                    ...
                    <div class="menu-section-twirl-section-inner">
                        ...
                        <div class="menu-twirl-option-outer">
                            <div class="menu-twirl-option-inner">
                                ...
                                <div class="menu-twirl-right">
                                <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_8" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_8 === 1) ? 'checked' : '' : ''}}>
                                </div>  <!-- END .menu-twirl-right -->
                            </div>  <!-- END .menu-twirl-option-inner -->
                        ...
                        <div class="menu-twirl-option-inner">
                            ...
                            <div class="menu-twirl-right">
                            <input type="checkbox" class="menu-twirl-toggle" name="twitter-settings[]" id="toggle_9" {{ isset($twitterSettingToggler) ? ($twitterSettingToggler->toggle_9 === 1) ? 'checked' : '' : ''}}>
                            </div>  <!-- END .menu-twirl-right -->
                        </div>  <!-- END .menu-twirl-option-inner -->
                                        ...
                                        <div class="menu-subTwirl-inner">
                                            <textarea class="thread-ender-text" id="text_ender_dm" >{{ isset($twitterSetting) ? $twitterSetting['text_ender_dm'] : "" }}</textarea>
                                            <div class="thread-ender-counter">
                                            <span class="thread-ender-count">154</span>/280 remaining
                                            </div>  <!-- END .thread-ender-count -->
