                  ...
                  <div class="profile-posts-outer">
                    <div class="profile-posts-inner">
                      ...
                      <!-- END Single Post Instance -->
                                    ...
                                    <div class=mosaic-posts-outer><div class="frosted mosaic-watermark-wrap"><img class=mosaic-watermark src="{{ asset('public') }}/ui-images/icons/pg-twitter.svg"><div class=mosaic-posts-inner><div class=mosaic-post-controls><span class=mosaic-control-icon><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-twitter.svg"></span><span class=mosaic-control-icon><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-trash.svg"></span></div><div class=global-twitter-profile-header><a href=#><img class=global-profile-image src="{{ asset('public') }}/temp-images/william-wallace.jpg"></a><div class=global-profile-details><div class=global-profile-name><a href=#>William Wallace</a></div><div class=global-profile-subdata><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-time.svg"> <span class=global-post-date><a href="">Dec. 16, 2022 @ 5:20 p.m.</a></span></div></div></div><div class=mosaic-post-data><div class=mosaic-post-text>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu. #pretium quis #sem #Nulla con</div></div><div class=mosaic-post-scheduling><div class="mosaic-scheduling mosaic-scheduling-now"><span class="mosaic-label mosaic-now-label"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-comment.svg"> Now </span><span class="mosaic-sched-buttons mosaic-now-buttons"><img src="{{ asset('public') }}/ui-images/icons/pg-heart.svg" class="ui-icon" /><img class="ui-icon comment-now-icon" src="{{ asset('public') }}/ui-images/icons/pg-comment.svg"> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-retweet.svg"></span></div><div class="mosaic-scheduling mosaic-scheduling-future"><span class="mosaic-label mosaic-future-label"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/04-queue.svg"> Schedule </span><span class="mosaic-sched-buttons mosaic-future-buttons"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-comment.svg"> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-retweet.svg"> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/16-evergreen.svg"></span></div><div class="mosaic-scheduling mosaic-post-analytics"><span class="mosaic-label mosaic-analytics-label"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-analytics.svg"> Analytics </span><span class="mosaic-sched-buttons mosaic-analytics-buttons"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-retweet.svg"> <span class="mosaic-stat stat-retweets">2.20</span> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-heart.svg"> <span class="mosaic-stat stat-hearts">2010</span></span></div></div></div></div><div class="comment-now-modal"><div class="comment-now-modal-inner frosted"><form><textarea></textarea><input type="submit" class="comment-now-submit" value="Comment Now" /></form></div>  <!-- END .comment-now-modal-inner --></div><!-- END .comment-now-modal --></div>

                                    <div class=mosaic-posts-outer><div class="frosted mosaic-watermark-wrap"><img class=mosaic-watermark src="{{ asset('public') }}/ui-images/icons/pg-twitter.svg"><div class=mosaic-posts-inner><div class=mosaic-post-controls><span class=mosaic-control-icon><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-twitter.svg"></span><span class=mosaic-control-icon><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-trash.svg"></span></div><div class=global-twitter-profile-header><a href=#><img class=global-profile-image src="{{ asset('public') }}/temp-images/william-wallace.jpg"></a><div class=global-profile-details><div class=global-profile-name><a href=#>William Wallace</a></div><div class=global-profile-subdata><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-time.svg"> <span class=global-post-date><a href="">Dec. 16, 2022 @ 5:20 p.m.</a></span></div></div></div><div class=mosaic-post-data><div class=mosaic-post-text>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu. #pretium quis #sem #Nulla con</div><img class=mosaic-post-image src=https://pulpbits.net/wp-content/uploads/2014/01/Eclectus-parrot-male-1024x1365.jpg></div><div class=mosaic-post-scheduling><div class="mosaic-scheduling mosaic-scheduling-now"><span class="mosaic-label mosaic-now-label"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-comment.svg"> Now </span><span class="mosaic-sched-buttons mosaic-now-buttons"><img src=""{{ asset('public') }}/ui-images/icons/pg-heart.svg"" class="ui-icon" /><img class="ui-icon comment-now-icon" src="{{ asset('public') }}/ui-images/icons/pg-comment.svg"> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-retweet.svg"></span></div><div class="mosaic-scheduling mosaic-scheduling-future"><span class="mosaic-label mosaic-future-label"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/04-queue.svg"> Schedule </span><span class="mosaic-sched-buttons mosaic-future-buttons"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-comment.svg"> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-retweet.svg"> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/16-evergreen.svg"></span></div><div class="mosaic-scheduling mosaic-post-analytics"><span class="mosaic-label mosaic-analytics-label"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-analytics.svg"> Analytics </span><span class="mosaic-sched-buttons mosaic-analytics-buttons"><img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-heart.svg"> <span class="mosaic-stat stat-retweets">2.20</span> <img class=ui-icon src="{{ asset('public') }}/ui-images/icons/pg-heart.svg"> <span class="mosaic-stat stat-hearts">2010</span></span></div></div></div></div><div class="comment-now-modal"><div class="comment-now-modal-inner frosted"><form><textarea></textarea><input type="submit" class="comment-now-submit" value="Comment Now" /></form></div>  <!-- END .comment-now-modal-inner --></div><!-- END .comment-now-modal --></div>
